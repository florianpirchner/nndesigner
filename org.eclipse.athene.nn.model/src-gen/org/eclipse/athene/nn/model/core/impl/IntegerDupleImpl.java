 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.athene.nn.model.core.impl.IntegerDupleImpl#getValue1 <em>Value1</em>}</li>
 *   <li>{@link org.eclipse.athene.nn.model.core.impl.IntegerDupleImpl#getValue2 <em>Value2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerDupleImpl extends MinimalEObjectImpl.Container implements IntegerDuple {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.INTEGER_DUPLE;
	}
	...
	public void setValue1(int newValue1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INTEGER_DUPLE__VALUE1, oldValue1, value1));
	}
	...
	public void setValue2(int newValue2) {
		...
		value2 = newValue2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INTEGER_DUPLE__VALUE2, oldValue2, value2));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.INTEGER_DUPLE__VALUE1:
				return getValue1();
			case CorePackage.INTEGER_DUPLE__VALUE2:
				return getValue2();
		}
