	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.MODEL: {
				...
				if (result == null) result = caseLayer(model);
				if (result == null) result = caseElement(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.FUNCTION: {
			...
			case CorePackage.SHAPE: {
				Shape shape = (Shape)theEObject;
				T result = caseShape(shape);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.SHAPE2_D: {
			...
			case CorePackage.LOSS_FUNCTION: {
			...
			case CorePackage.INITIALIZER_FUNCTION: {
			...
			case CorePackage.MATH_FUNCTION: {
			...
			case CorePackage.MATMUL_FUNCTION: {
