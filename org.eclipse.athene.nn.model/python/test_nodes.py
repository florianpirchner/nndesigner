...
print("")
print("")
print("---- iterate outbound nodes and tensors ----")
print("")
print("")
print("LSTM")
for n in lstm.outbound_nodes:
	print("")
	print("Out-Node ",  n.get_config())
	for t in n.input_tensors :
		print("        In-Tensor ",  t)
	for t in n.output_tensors :
		print("        Out-Tensor ",  t)
...
print("")
print("---- inputs ----")
#print(lstm.inbound_nodes)
print(lstm.get_input_at(0))
print(lstm.get_input_at(1))
...
print("")
print("---- outputs ----")
#print(lstm.outbound_nodes)
print(lstm.get_output_at(0))
print(lstm.get_output_at(1))
