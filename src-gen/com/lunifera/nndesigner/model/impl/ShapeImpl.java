 ...
 * </p>
 * <ul>
 *   <li>{@link com.lunifera.nndesigner.model.impl.ShapeImpl#getBatchSize <em>Batch Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ShapeImpl extends MinimalEObjectImpl.Container implements Shape {
	...
	public void setBatchSize(int newBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SHAPE__BATCH_SIZE, oldBatchSize, batchSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SHAPE__BATCH_SIZE:
				return getBatchSize();
		}
