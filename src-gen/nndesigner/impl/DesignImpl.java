 ...
 * </p>
 * <ul>
 *   <li>{@link nndesigner.impl.DesignImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DesignImpl extends MinimalEObjectImpl.Container implements Design {
	...
	protected EClass eStaticClass() {
		return NndesignerPackage.Literals.DESIGN;
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, NndesignerPackage.DESIGN__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NndesignerPackage.DESIGN__ELEMENTS:
