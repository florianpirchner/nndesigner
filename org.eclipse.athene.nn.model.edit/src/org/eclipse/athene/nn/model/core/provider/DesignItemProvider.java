...
/**
 * This is the item provider adapter for a {@link org.eclipse.athene.nn.model.core.Design} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DesignItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.DESIGN__ELEMENTS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Design_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Design.class)) {
			case CorePackage.DESIGN__ELEMENTS:
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.DESIGN__ELEMENTS,
				 CoreFactory.eINSTANCE.createMatmulFunction()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.DESIGN__ELEMENTS,
				 CoreFactory.eINSTANCE.createDotFunction()));
	}
