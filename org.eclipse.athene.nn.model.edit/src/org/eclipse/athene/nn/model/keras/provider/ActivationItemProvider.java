...
/**
 * This is the item provider adapter for a {@link org.eclipse.athene.nn.model.keras.Activation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivationItemProvider extends LayerItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activation_activationFunction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activation_activationFunction_feature", "_UI_Activation_type"),
				 KerasPackage.Literals.ACTIVATION__ACTIVATION_FUNCTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KerasPackage.Literals.ACTIVATION__INPUT_SHAPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KerasPackage.Literals.ACTIVATION__INPUT_SHAPE,
